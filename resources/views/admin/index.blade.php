...
<html lang="en">
	<head>
		...
		<link rel="icon" href="favicon.ico" type="{{ URL::to('public/image/x-icon') }}">
	...
	<body>
		...
		<div class="wrapper pa-0">
			<header class="sp-header">
				<div class="sp-logo-wrap pull-left">
					<a href="#">
						<img class="brand-img mr-10" src="{{ URL::to('public/dist/img/logo.png') }}" alt="brand"/>
						<span class="brand-text">IOT</span>
					</a>
				</div>
				<div class="form-group mb-0 pull-right" style="display: none;">
							...
							<div class="auth-form  ml-auto mr-auto no-float">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to IOT</h3>
		...
		<script src="{{ URL::to('public/vendors/bower_components/jasny-bootstrap/dist/js/jasny-bootstrap.min.js') }}"></script>
